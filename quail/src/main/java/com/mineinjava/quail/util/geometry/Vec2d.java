 ...
 *
 * @author Alex Green, Marcus Kauffman
 */
public class Vec2d {
  ...
  /**
   * Rotates the vector by the passed amount. Positive rotation is counterclockwise, and negative
  ...
  public boolean equals(Object obj) {
    return obj == this
        || (obj instanceof Vec2d && ((Vec2d) obj).x == this.x && ((Vec2d) obj).y == this.y);
  }
